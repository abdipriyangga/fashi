...
<div class="sidebar">
    ...
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
        <a href="../admin/logout-admin.php" class="nav-link">
        ...
        <ul class="nav nav-treeview">
            <li class="nav-item">
            <a href="insert-data.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Insert Data Barang</p>
            </a>
            </li>
            <li class="nav-item">
            <a href="tampil-barang.php" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Tampil Data Barang</p>
            </a>
            </li>
            <li class="nav-item">
